...
public class SecurityConfig {
   ...
   // private final String[] PUBLIC_ENDPOINTS_GET = {"/categories", "/products/category/{maDanhMuc}", "/products/top-10", "/products/last-7-days", "/cart", "/products/search", "/products/{id}", "/products"};
    private final String[] PUBLIC_ENDPOINTS_GET = {"/users/{userId}", "/categories", "/category/**", "/products/**", "/cart", "/favorites/**", "/filter", "/orders/**", "/cart/{userId}", "/address/**", "/shops/**","/feedbacks/{productId}","/feedbacks/checkFeedback"};
