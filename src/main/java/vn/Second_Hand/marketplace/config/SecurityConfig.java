...
public class SecurityConfig {
    private final String[] PUBLIC_ENDPOINTS_POST = {"/auth/register", "/auth/login", "/auth/verify-token"};
    private final String[] PUBLIC_ENDPOINTS_PUT = {"/auth/verify-account", "/auth/regenerate-otp", "/auth/forgot-password", "/auth/reset-password"};
    private final String[] PUBLIC_ENDPOINTS_GET = {"/marketplace/categories", "/marketplace/products/category/{maDanhMuc}", "/marketplace/products/top-10", "/marketplace/products/last-7-days"};
