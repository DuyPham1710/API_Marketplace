...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS_GET = {"/marketplace/categories", "/marketplace/products/category/{maDanhMuc}", "/marketplace/products/top-10", "/marketplace/products/last-7-days", "/cart"};
